...
public class VideoPredicates {
	...
	public static Predicate videoCategoryEqualsAndOwnerIdEquals(UUID ownerId, Category category) {
		return QVideo.video.privacyType.eq(PrivacyType.PUBLIC).and(QVideo.video.owner.id.eq(ownerId))
				.and(QVideo.video.category.eq(category));
	}
	...
	public static Predicate videoPublicAndCategory(Category category) {
		return QVideo.video.privacyType.eq(PrivacyType.PUBLIC).and(QVideo.video.category.eq(category));
	}
